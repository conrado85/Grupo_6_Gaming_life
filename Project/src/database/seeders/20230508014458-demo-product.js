...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    },
    {
      ...
      description: 'Con la unidad en estado sólido Lexar vas a incrementar la capacidad de respuesta de tu equipo. Gracias a esta tecnología podrás invertir en velocidad y eficiencia para el inicio, la carga y la transferencia de datos. Más velocidad a tu alcance.Este disco transfiere datos a través de una interfaz M.2, NVMe, PCIe, lo que te brindará trasmitir una mayor cantidad de información de una sola vez.',
      price: '22000.00',
    ...
    },
    {
      ...
      description: 'Marca	ASRock Línea	OEM Modelo	B360M Versión	1.0 Color	Negro Chipsets: Intel B360 Socket: Lga 1151 (300 series) Ranuras de expansión: Pci express 3.0 x16 2 x pcie 3.0 x16 (16/4) pci express x1 2 x pcie 3.0 x1',
      price: '26324.00',
